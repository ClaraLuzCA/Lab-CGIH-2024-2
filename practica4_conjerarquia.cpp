...
int main()
{
	...
	*/
	...
	glm::mat4 brazo1aux(1.0);
	glm::mat4 brazo2aux(1.0);
	glm::mat4 brazo3aux(1.0);
	glm::mat4 brazo4aux(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Cuerpo del robot
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(2.0f, 6.0f, -4.0f)); //colocando la cabina en su posición
		modelaux = model;
		modelaux2 = model;
		...
		//Cabeza del robot
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, 0.75f, 0.0f)); //colocando la cabina en su posición
		modelaux2 = model;
		...
		//articulación 1
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.95f, -0.25f, 0.5f));
		...
		model = glm::rotate(model, glm::radians(-120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(1.0f, 0.6f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion22()), glm::vec3(0.0f, 0.0f, 1.0f));
		brazo2aux = model;
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		...
		//brazo1
		model = brazo3aux;
		model = glm::translate(model, glm::vec3(0.9f, 0.6f, -0.1f));
		model = glm::rotate(model, glm::radians(120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		brazo3aux = model;
		model = glm::scale(model, glm::vec3(0.25f, 2.0f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(-1.0f, 0.6f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion32()), glm::vec3(0.0f, 0.0f, -1.0f));
		brazo3aux = model;
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		...
		model = glm::rotate(model, glm::radians(120.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(-1.0f, 0.6f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion42()), glm::vec3(0.0f, 0.0f, 1.0f));
		brazo4aux = model;
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
