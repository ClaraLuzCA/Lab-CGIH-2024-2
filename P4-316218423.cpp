...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//base de la grua 
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, -1.0f, 0.0f)); //colocando la cabina en su posición
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(5.0f, 2.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelaux2;
		model = glm::translate(model, glm::vec3(2.0f, -1.0f, 1.7f));
		...
		//llanta adelante derecha
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-2.0f, -1.0f, 1.7f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		//rotación de la llanta
		model = glm::rotate(model, glm::radians(mainWindow.getllanta3()), glm::vec3(0.0f, 1.0f, .0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry(); //dibuja cilindro
		...
		//articulación 1
		model = modelaux;
		//rotación alrededor de la articulación que une con la cabina utilizando las teclas
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.5f,0.0f, 0.0f)); // desplazarse 2.5 en x 
		modelaux = model;
		model = glm::scale(model, glm::vec3(5.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		...
		//canasta
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.1f,1.0f, 0.0f)); // desplazarse 2.5 en x 
